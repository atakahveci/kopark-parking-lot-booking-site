                ...
                <center>
                    ...
                    <div class="CardDiv">
                        ...
                        <div style="padding:15px 16px 15px 16px;  height: auto; overflow: auto; ">
                            ...
                            <a href="dolphin.php"><button type="button" class="btnr"
                    ...
                    <div class="CardDiv">
                        ...
                        <div style="padding:15px 16px 15px 16px;  height: auto; overflow: auto; ">
                            ...
                            <form action="vtdolphin.php" method="post" style="margin-bottom: 10px;">
                        ...
                        <?php       
                            ...
                            $sorgu="select * from dolphinfeedback;";
...
<div class="container" >
           <div class="content-container clearfix"style="background-color:#0B1320; border-radius:8px;">
  ...
  padding-top: 8px;
    color:#EAAD04; margin-top: 1px; margin-left: 8px; padding-left: 6px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">
               ...
               <p
                                style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  color:#DDDEE5; text-align:left;">
                                Başka kullanıcıların yorumlarını ve puanlarını görmek için en aşağıdaki bölüme bakınız! Sizin eklemiş olduğunuz yorum listenin en alt kısmında yer almaktadır.
                   ...
                   <ul class="mail-list">
                            ...
                            <tr>
                                <td style="padding:45px; 
                                    ...
                                    <span class="mail-sender" style="font-size:15px; font-weight:500;">
                                        <?php echo $row['adsoyad']; ?>
                                        </span> <br>
                                    <span class="mail-subject" style="font-size:14px; font-weight:500;">
                                    ...
                                    <span class="mail-subject rateYo-<?php $row['id']; ?>"
                                        ...
                                        <h3 class="media-heading"> <div class="rateYo-<?php echo $row['id']; ?>"></div></h3>
                                        <script>
                                        $(function(){
