        ...
        <center>
            <div class="CardDiv" style="background-color: #f0f0f0;">
                <div class="GreenTitleDiv">
                    <h3 style=" float:left; margin-top: 1px; margin-left: 8px; padding-left: 6px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">Dolphin Otopark Rezarvasyonları</h3>
                </div>
                            ...
                            <thead style="padding-left:90px; padding-right:90px;">
                                <tr style="padding-left:90px; padding-right:90px;">
                                    ...
                                    <tr>
                                        ...
                                        <td> <a class="btnper btn-danger" style="font-size:11px" href="dolphinsil.php?delete=<?php echo $row['park']; ?>">Kaldır</a></td>
                                    </tr>
                                      <?php
                                        endwhile;
                                        ?>
