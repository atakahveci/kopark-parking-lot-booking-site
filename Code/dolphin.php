<?php
  require_once 'dolphinparkalani.php';
  $A1=$_SESSION['a1'];
  $A2=$_SESSION['a2'];
  $A3=$_SESSION['a3'];
  $A4=$_SESSION['a4'];
        ...
        <center> 
            ...
            <div class="CardDiv">
                <div class="GreenTitleDiv">
                    <h3 style=" float:left; margin-top: 1px; margin-left: 8px; padding-left: 6px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif"> DOLPHIN CENTER - Yer Altı</h3>
                </div>
                <div style="padding:15px 16px 15px 16px;  height: auto; overflow: auto; ">
                <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1aRIPRiFv8Eo8IImAkoI-0T21E_C6Rcxx" id="pic2" width="330" height="300"></iframe>
                <p style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  color:#DDDEE5; text-align:left;font-weight:700;">Çok Katlı Otopark</p>
                    ...
                    <a href="dolphinyorumlar.php"><button type="button" class="btnr" style="float:right; font-family:'Segoe UI'; padding:4px 14px 4px 14px; font-size:14px; font-weight:500;" >Yorumlar</button></a>
                    <p style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  color:#DDDEE5; text-align:left;">
    ...
    <div id="fond" style="width:350px; height:auto;margin:0 auto; padding:16px; " class="container">
       ...
       <?php 
        ...
        <option disabled selected value>Seçiniz</option>
            <option value="4.5">0 - 1 Saat</option>
            <option value="5.75">1 - 2 Saat</option>
            <option value="7.25">2 - 4 Saat</option>
            <option value="11">12 - 24 Saat</option>
        </select>
        
        <select id="box2" style="display: none;" name="saat">
        <option disabled selected value>Seçiniz</option>
             <option value="0 - 1">4.5TL</option>
             <option value="1 - 2">5.75TL</option>
             <option value="2 - 4">7.25TL</option>
             <option value="12 - 24">11TL</option>
            </select>
         </div>
            ...
            <td align="left" class="sm-p-20 sm-dui17-b-t" style="border-radius: 2px; padding: 40px; position: relative; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, .1), 0 4px 6px -2px rgba(0, 0, 0, .05); vertical-align: top;" bgcolor="#ffffff" valign="top">
              ...
              <table class="sm-leading-32" style="line-height: 28px; font-size: 14px;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                ...
                <tr>
                  ...
                  <td class="sm-inline-block" style="font-weight: 600; color:#000000; text-align: right;" width="50%" align="right">Dolphin Otopark</td>
                </tr>
                <tr>
                  <td class="sm-w-1-4 sm-inline-block" style="color: #718096;" width="50%">Address</td>
                  <td class="sm-w-3-4 sm-inline-block" style="font-weight: 600;color:#000000; text-align: right;" width="50%" align="right">Körfez, Berk Sk. No:1</td>
                </tr>
              </table>
