...
$kaydet="INSERT INTO dolphinrez (park, tutar, saat, adsoyad, numara, araba, plaka) VALUES('$park', '$tutar', '$saat', '$adsoyad', '$numara', '$araba', '$plaka')";
     if (mysqli_query($db_conn, $kaydet)) {
        $guncelle="UPDATE dolphinparkalani SET durum = 'dolu' WHERE parkkodu = '$park'";
