...
$kaydet="INSERT INTO seymenrez (park, tutar, saat, adsoyad, numara, araba, plaka) VALUES('$park', '$tutar', '$saat', '$adsoyad', '$numara', '$araba', '$plaka')";
     if (mysqli_query($db_conn, $kaydet)) {
        $guncelle="UPDATE seymenparkalani SET durum = 'dolu' WHERE parkkodu = '$park'";
