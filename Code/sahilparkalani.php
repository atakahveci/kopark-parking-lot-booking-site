...
$adi_sorgu="select sahilparkalani.parkkodu, sahilparkalani.durum FROM sahilparkalani" ;  
...
$row = mysqli_fetch_assoc($sonuc_adi);    //BURASI  ATA BURASI BUNDAN ŞEYEDE YAPACAKSIN PARKALANLARINA VE SONRA BİİTİYORRR HADİ KOLAYGELSİN
        ...
        $a1="select durum from sahilparkalani where parkkodu='A1'";
        ...
        $a2="select durum from sahilparkalani where parkkodu='A2'";
        ...
        $a3="select durum from sahilparkalani where parkkodu='A3'";
        ...
        $a4="select durum from sahilparkalani where parkkodu='A4'";
        ...
        $a5="select durum from sahilparkalani where parkkodu='A5'";
        ...
        $a6="select durum from sahilparkalani where parkkodu='A6'";
        ...
        $a7="select durum from sahilparkalani where parkkodu='A7'";
        ...
        $a8="select durum from sahilparkalani where parkkodu='A8'";
        ...
        $a9="select durum from sahilparkalani where parkkodu='A9'";
        ...
        $a10="select durum from sahilparkalani where parkkodu='A10'";
        ...
        $a11="select durum from sahilparkalani where parkkodu='A11'";
        ...
        $a12="select durum from sahilparkalani where parkkodu='A12'";
        ...
        $b1="select durum from sahilparkalani where parkkodu='B1'";
        ...
        $b2="select durum from sahilparkalani where parkkodu='B2'";
        ...
        $b3="select durum from sahilparkalani where parkkodu='B3'";
        ...
        $b4="select durum from sahilparkalani where parkkodu='B4'";
        ...
        $b5="select durum from sahilparkalani where parkkodu='B5'";
        ...
        $b6="select durum from sahilparkalani where parkkodu='B6'";
        ...
        $b7="select durum from sahilparkalani where parkkodu='B7'";
        ...
        $b8="select durum from sahilparkalani where parkkodu='B8'";
        ...
        $b9="select durum from sahilparkalani where parkkodu='B9'";
        ...
        $b10="select durum from sahilparkalani where parkkodu='B10'";
        ...
        $b11="select durum from sahilparkalani where parkkodu='B11'";
        ...
        $b12="select durum from sahilparkalani where parkkodu='B12'";
        ...
        $b13="select durum from sahilparkalani where parkkodu='B13'";
        ...
        $b14="select durum from sahilparkalani where parkkodu='B14'";
        ...
        $b15="select durum from sahilparkalani where parkkodu='B15'";
        ...
        $b16="select durum from sahilparkalani where parkkodu='B16'";
        ...
        $c1="select durum from sahilparkalani where parkkodu='C1'";
        ...
        $c2="select durum from sahilparkalani where parkkodu='C2'";
        ...
        $c3="select durum from sahilparkalani where parkkodu='C3'";
        ...
        $c4="select durum from sahilparkalani where parkkodu='C4'";
        ...
        $c5="select durum from sahilparkalani where parkkodu='C5'";
        ...
        $c6="select durum from sahilparkalani where parkkodu='C6'";
        ...
        $c7="select durum from sahilparkalani where parkkodu='C7'";
        ...
        $c8="select durum from sahilparkalani where parkkodu='C8'";
        ...
        $c9="select durum from sahilparkalani where parkkodu='C9'";
        ...
        $c10="select durum from sahilparkalani where parkkodu='C10'";
        ...
        $c11="select durum from sahilparkalani where parkkodu='C11'";
        ...
        $c12="select durum from sahilparkalani where parkkodu='C12'";
        ...
        $c13="select durum from sahilparkalani where parkkodu='C13'";
        ...
        $c14="select durum from sahilparkalani where parkkodu='C14'";
        ...
        $c15="select durum from sahilparkalani where parkkodu='C15'";
        ...
        $c16="select durum from sahilparkalani where parkkodu='C16'";
        ...
        $d1="select durum from sahilparkalani where parkkodu='D1'";
        ...
        $d2="select durum from sahilparkalani where parkkodu='D2'";
        ...
        $d3="select durum from sahilparkalani where parkkodu='D3'";
        ...
        $d4="select durum from sahilparkalani where parkkodu='D4'";
        ...
        $d5="select durum from sahilparkalani where parkkodu='D5'";
        ...
        $d6="select durum from sahilparkalani where parkkodu='D6'";
        ...
        $d7="select durum from sahilparkalani where parkkodu='D7'";
        ...
        $d8="select durum from sahilparkalani where parkkodu='D8'";
        ...
        $d9="select durum from sahilparkalani where parkkodu='D9'";
        ...
        $d10="select durum from sahilparkalani where parkkodu='D10'";
        ...
        $d11="select durum from sahilparkalani where parkkodu='D11'";
        ...
        $d12="select durum from sahilparkalani where parkkodu='D12'";
        ...
        $e1="select durum from sahilparkalani where parkkodu='E1'";
        ...
        $e2="select durum from sahilparkalani where parkkodu='E2'";
        ...
        $e3="select durum from sahilparkalani where parkkodu='E3'";
        ...
        $e4="select durum from sahilparkalani where parkkodu='E4'";
        ...
        $e5="select durum from sahilparkalani where parkkodu='E5'";
        ...
        $e6="select durum from sahilparkalani where parkkodu='E6'";
        ...
        $e7="select durum from sahilparkalani where parkkodu='E7'";
        ...
        $e8="select durum from sahilparkalani where parkkodu='E8'";
        ...
        $e9="select durum from sahilparkalani where parkkodu='E9'";
        ...
        $e10="select durum from sahilparkalani where parkkodu='E10'";
        ...
        $e11="select durum from sahilparkalani where parkkodu='E11'";
        ...
        $e12="select durum from sahilparkalani where parkkodu='E12'";
        ...
        $f1="select durum from sahilparkalani where parkkodu='F1'";
        ...
        $f2="select durum from sahilparkalani where parkkodu='F2'";
        ...
        $f3="select durum from sahilparkalani where parkkodu='F3'";
        ...
        $f4="select durum from sahilparkalani where parkkodu='F4'";
        ...
        $f5="select durum from sahilparkalani where parkkodu='F5'";
        ...
        $f6="select durum from sahilparkalani where parkkodu='F6'";
        ...
        $f7="select durum from sahilparkalani where parkkodu='F7'";
        ...
        $f8="select durum from sahilparkalani where parkkodu='F8'";
        ...
        $f9="select durum from sahilparkalani where parkkodu='F9'";
        ...
        $f10="select durum from sahilparkalani where parkkodu='F10'";
        ...
        $f11="select durum from sahilparkalani where parkkodu='F11'";
        ...
        $f12="select durum from sahilparkalani where parkkodu='F12'";
        ...
        $f13="select durum from sahilparkalani where parkkodu='F13'";
        ...
        $f14="select durum from sahilparkalani where parkkodu='F14'";
        ...
        $f15="select durum from sahilparkalani where parkkodu='F15'";
        ...
        $f16="select durum from sahilparkalani where parkkodu='F16'";
        ...
        $g1="select durum from sahilparkalani where parkkodu='G1'";
        ...
        $g2="select durum from sahilparkalani where parkkodu='G2'";
        ...
        $g3="select durum from sahilparkalani where parkkodu='G3'";
        ...
        $g4="select durum from sahilparkalani where parkkodu='G4'";
        ...
        $g5="select durum from sahilparkalani where parkkodu='G5'";
        ...
        $g6="select durum from sahilparkalani where parkkodu='G6'";
        ...
        $g7="select durum from sahilparkalani where parkkodu='G7'";
        ...
        $g8="select durum from sahilparkalani where parkkodu='G8'";
        ...
        $g9="select durum from sahilparkalani where parkkodu='G9'";
        ...
        $g10="select durum from sahilparkalani where parkkodu='G10'";
        ...
        $g11="select durum from sahilparkalani where parkkodu='G11'";
        ...
        $g12="select durum from sahilparkalani where parkkodu='G12'";
        ...
        $g13="select durum from sahilparkalani where parkkodu='G13'";
        ...
        $g14="select durum from sahilparkalani where parkkodu='G14'";
        ...
        $g15="select durum from sahilparkalani where parkkodu='G15'";
        ...
        $g16="select durum from sahilparkalani where parkkodu='G16'";
        ...
        $h1="select durum from sahilparkalani where parkkodu='H1'";
        ...
        $h2="select durum from sahilparkalani where parkkodu='H2'";
        ...
        $h3="select durum from sahilparkalani where parkkodu='H3'";
        ...
        $h4="select durum from sahilparkalani where parkkodu='H4'";
        ...
        $h5="select durum from sahilparkalani where parkkodu='H5'";
        ...
        $h6="select durum from sahilparkalani where parkkodu='H6'";
        ...
        $h7="select durum from sahilparkalani where parkkodu='H7'";
        ...
        $h8="select durum from sahilparkalani where parkkodu='H8'";
        ...
        $h9="select durum from sahilparkalani where parkkodu='H9'";
        ...
        $h10="select durum from sahilparkalani where parkkodu='H10'";
        ...
        $h11="select durum from sahilparkalani where parkkodu='H11'";
        ...
        $h12="select durum from sahilparkalani where parkkodu='H12'";
