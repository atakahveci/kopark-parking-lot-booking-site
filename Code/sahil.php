<?php
  require_once 'sahilparkalani.php';
  $A1=$_SESSION['a1'];
  $A2=$_SESSION['a2'];
  $A3=$_SESSION['a3'];
  $A4=$_SESSION['a4'];
...
<head>
  ...
  >
        ...
        <center> 
            ...
            <div class="CardDiv">
                <div class="GreenTitleDiv">
                    <h3 style=" float:left; margin-top: 1px; margin-left: 8px; padding-left: 6px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">Sahil Otopark</h3>
                </div>
                <div style="padding:15px 16px 15px 16px;  height: auto; overflow: auto; ">
                <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1Ih6y9x7LYYZrPuOVm0ZgIJiVkxGcpRza" id="pic2" width="330" height="300"></iframe>
                <p style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  color:#DDDEE5; text-align:left;font-weight:700;">Yol Dışı Otopark</p>
                <p style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  color:#DDDEE5; text-align:left;">
                    ...
                    <a href="sahilyorumlar.php"><button type="button" class="btnr" style="float:right; font-family:'Segoe UI'; padding:4px 14px 4px 14px; font-size:14px; font-weight:500;" >Yorumlar</button></a>
                    <p style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  color:#DDDEE5; text-align:left;">
    ...
    <br>
            ...
            <form
              action="vtsahilrez.php"
              method="post"
              style="margin-bottom: 10px;"
            >


<p style="color:#EAAD04; font-weight:600;">Batı Tarafı</p>
    <div id="fond" style="width:350px; height:auto;margin:0 auto; padding:16px; " class="container">
       ...
       <?php 
        ...
        <?php 
        if($A3=="dolu"){
            echo" <div style=\"\" class=\"seat occupied\">
            <label class=\"flow-option\">
        ...
        <?php 
        if($A4=="bos"){
            echo" <div style=\"  margin-right:230px;\" class=\"seat\">
            <label class=\"flow-option\">
        ...
        <?php 
        if($A4=="dolu"){
            echo" <div style=\" margin-right:230px;\" class=\"seat occupied\">
            <label class=\"flow-option\">
       ...
       <?php 
        ...
        <?php 
        if($A11=="bos"){
            echo" <div style=\"  margin-bottom:2px;\" class=\"seat\">
            <label class=\"flow-option\">
        ...
        <?php 
        if($A11=="dolu"){
            echo" <div style=\"  margin-bottom:2px;\" class=\"seat occupied\">
            <label class=\"flow-option\">
       ...
       <?php 
        ...
        <br>
        <p style="color:#EAAD04; font-weight:600;">Doğu Tarafı</p>
    <div id="fond" style="width:350px; height:auto;margin:0 auto; padding:16px; " class="container">
        <div style="margin-left:3px; margin-top:1px;">
        <div class="row">
        <?php 
       ...
       <?php 
        ...
        <option disabled selected value>Seçiniz</option>
            ...
            <option value="8">2 - 4 Saat</option>
            <option value="10">12 - 24 Saat</option>
        </select>
        
        <select id="box2" style="display: none;" name="saat">
        <option disabled selected value>Seçiniz</option>
             <option value="0 - 1">4TL</option>
             <option value="1 - 2">5TL</option>
             <option value="2 - 4">8TL</option>
             <option value="12 - 24">10TL</option>
            </select>
         </div>
            ...
            <td align="left" class="sm-p-20 sm-dui17-b-t" style="border-radius: 2px; padding: 40px; position: relative; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, .1), 0 4px 6px -2px rgba(0, 0, 0, .05); vertical-align: top;" bgcolor="#ffffff" valign="top">
              ...
              <table class="sm-leading-32" style="line-height: 28px; font-size: 14px;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                ...
                <tr>
                  ...
                  <td class="sm-inline-block" style="font-weight: 600; color:#000000; text-align: right;" width="50%" align="right">Sahil Otopark</td>
                </tr>
                <tr>
                  <td class="sm-w-1-4 sm-inline-block" style="color: #718096;" width="50%">Address</td>
                  <td class="sm-w-3-4 sm-inline-block" style="font-weight: 600;color:#000000; text-align: right;" width="50%" align="right">Ömerağa, 41300</td>
                </tr>
              </table>
